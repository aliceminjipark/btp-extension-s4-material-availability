 ...
 *
 * @param {TableTypeV4} tableType - The type of the table for which the definition name is required.
 * @return {DefinitionName} - The corresponding table definition name, or a default name if the table type is not found.
 */
